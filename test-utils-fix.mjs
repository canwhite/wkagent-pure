...
// 测试用例2: 英文非JSON内容
const englishText =
  "I'll generate a complete story outline for you. Based on the three-act structure...";
...
// 测试用例3: 有效的JSON对象
const validJSON =
  '{"title": "测试项目", "sections": [{"name": "部分1", "content": "内容"}]}';
